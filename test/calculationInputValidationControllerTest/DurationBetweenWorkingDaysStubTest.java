...
//----	
	private static LocalDateTime workBeginTomorrow_8_01 = LocalDateTime.of(today, LocalTime.of(8,1));
	private static LocalDateTime workBeginTomorrow_8_00 = LocalDateTime.of(today, LocalTime.of(8,0));
	private static LocalDateTime workEndToday_21_00 = LocalDateTime.of(yesterday, LocalTime.of(21,0));
	private static LocalDateTime workEndToday_21_01 = LocalDateTime.of(yesterday, LocalTime.of(21,1));
	...
	// today - tomorrow
	@Test
	void daysDifferenceFromToday21_00_ToTomorrow8_00_is11H_isValid() {
		ValidationState validationBetweenDays = (dummyInputValidationControllerStub
				.checkDurationBetweenWorkingDays(workEndToday_21_00, workBeginTomorrow_8_00));
		
		assertEquals(ValidationState.VALID, validationBetweenDays);
	}
	
	@Test
	void daysDifferenceFromToday21_00_ToTomorrow8_01_is11H01M_isValid() {
		ValidationState validationBetweenDays = (dummyInputValidationControllerStub
				.checkDurationBetweenWorkingDays(workEndToday_21_00, workBeginTomorrow_8_01));
		
		assertEquals(ValidationState.VALID, validationBetweenDays);
	}
	
	@Test
	void daysDifferenceFromToday21_01_ToTomorrowy8_00_is10H59M_isNotValid() {
		ValidationState validationBetweenDays = (dummyInputValidationControllerStub
				.checkDurationBetweenWorkingDays(workEndToday_21_01, workBeginTomorrow_8_00));
