...
class TimeInputChronologicalOrderTest {
	...
	void inputSingleInterruption0_isValid() {
		...
		list = addInputToList(list, INTERRUPTION_0_WORKTIME2_STARTS_EXACTLY_WHEN_WORKTIME1_ENDS);

		ValidationState validationTimeOrder = dummyInputValidationControllerStub.checkTimeOrderIsChronological(list);

		assertEquals(ValidationState.VALID, validationTimeOrder);
	}
	
	@Test
	void inputSingleInterruptionPositiv_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1);
	...
	void inputSingleInterruptionNegativ_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_NEG_WORKTIME2_BEFORE_WORKTIME1);

		ValidationState validationTimeOrder = dummyInputValidationControllerStub.checkTimeOrderIsChronological(list);

		assertEquals(ValidationState.NOT_VALID_TIME_INPUT_MUST_BE_IN_CHRONICAL_ORDER, validationTimeOrder);
	}
	
	@Test
	void inputInterruptionPositivAndNegativ_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, INTERRUPTION_NEG_WORKTIME2_BEFORE_WORKTIME1);
	...
	void inputSingleBreakinterruption0_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAKINTERRUPTION_0_WORKTIME2_STARTS_EXACTLY_WHEN_WORKTIME1_ENDS);
	...
	void inputSingleBreakinterruptionPositiv_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAKINTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1);
	...
	void inputSingleBreakinterruptionNegativ_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAKINTERRUPTION_NEG_WORKTIME2_BEFORE_WORKTIME1);
	...
	void inputSingleBreak0WithoutBreakinterruption_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAK_0);
	...
	void inputValidSingleBreakWithoutBreakinterruption_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAK_VALID);
	...
	void inputInvalidSingleBreakWithoutBreakinterruption_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAK_INVALID);

		ValidationState validationTimeOrder = dummyInputValidationControllerStub.checkTimeOrderIsChronological(list);

		assertEquals(ValidationState.NOT_VALID_START_IS_AFTER_END, validationTimeOrder);
	}
	
	@Test
	void inputValidBreaksWithValidBreakTimeOrder_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAKINTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, BREAK_VALID, BREAK_VALID);
	...
	void inputInvalidBreaksWithValidBreakTimeOrder_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAKINTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, BREAK_INVALID, BREAK_INVALID);
	...
	void inputInvalidAndValidBreakWithValidBreakTimeOrder_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, BREAKINTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, BREAK_INVALID, BREAK_VALID);
	...
	void inputSingleWork0WithoutInterruption_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, WORK_0);
	...
	void inputValidSingleWorkkWithoutInterruption_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, WORK_VALID);
	...
	void inputInvalidSingleWorkWithoutInterruption_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, Work_INVALID);
	...
	void inputValidWorksWithValidWorkTimeOrder_isValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, WORK_VALID, WORK_VALID);
	...
	void inputInvalidWorksWithValidWorkTimeOrder_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, Work_INVALID, Work_INVALID);
	...
	void inputInvalidAndValidWorksWithValidBreakTimeOrder_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, Work_INVALID, WORK_VALID);
	...
	void inputOneInvalidWorkAndMultipleValidBreaksAndSecondValidWorkWithValidTimeOrders_isNotValid() {
		ArrayList<Timespann> list = new ArrayList<Timespann>();
		list = addInputToList(list, INTERRUPTION_POS_WORKTIME2_AFTER_WORKTIME1, WORK_VALID, Work_INVALID,
